...
documentation.  It often requires multiple iterations to determine whether a
detected failure stems from a faulty test, user document, or Grid resource.  
...
Typically, tests for each command listed in the user documentation and/or for
each software component of the Grid infrastructure are required.
