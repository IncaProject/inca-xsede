...
The goal of user-level Grid monitoring is to test and measure the Grid
...
errors and performance now in a historical context, which will benefit Grid
...
behavior.  They should also make it easier to resolve, in addition to detect
errors and understand them in a historical context.  The features that Inca
provides and its proposed enhancements should improve the stability of the
