...
the Inca reporter schema.  The goal of the reporter schema is to accomodate
multiple types of data and to capture information about the the reporter
...
Inca::Reporter::SimpleUnit is the API responsible for printing the simplist
...
18, 20) depending on the output of system command.  And finally, the
Inca::Reporter::GridProxy API (line~\ref{pingReporter}(a) 3) adds a proxy
dependency to the reporter which tells the Inca system to download a
