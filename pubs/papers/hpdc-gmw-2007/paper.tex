...
\item Creates and configures tests and performance measurements based on user
...
\item Represents overall Grid status by testing a variety of 
...
measurements to capture dynamic Grid status.
