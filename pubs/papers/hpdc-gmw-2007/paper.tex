...
User-level Grid monitoring is Grid infrastructure testing and performance measurement 
...
required since Grids are dynamic and software environments change over time as
...
Grid Integration Test Script~\cite{gits}, both of which ran a fixed number of Grid tests and formatted
...
Inca::Reporter::SimpleUnit and
Inca::Reporter::GridProxy (both subclasses of Inca::Reporter).  The Inca::Reporter API provides convenience
...
section), and a catalog file.  Repository contents are usually accessible using a URL
...
Inca's initial configuration and maintenance is therefore easier and less error prone.  
