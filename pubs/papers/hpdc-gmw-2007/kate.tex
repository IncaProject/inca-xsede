...
Inca has been deployed on TeraGrid since 2003 to validate and verify 
its Common TeraGrid Software and Services (CTSS).  TeraGrid's common user 
environment, supplied via the deployment and monitoring of CTSS, is 
designed to allow users to more easily run Grid jobs across TeraGrid's 
distributed, heterogeneous resources. 

In 2006, TeraGrid added reporters to collect job usage 
...
In 2006, TeraGrid's Inca deployment transitioned over to Inca 2  
and was deployed on 21 resources.   Each resource regularly executed 
