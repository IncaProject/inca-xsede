...
\usepackage{graphicx,subfigure,url, amsmath} 
...
\section{Introduction} (0.5 page) (Sameer and Shava)

\section{FutureGrid Overview} (0.5 page) (Shava) 
...
\section{Inca Architecture} (0.5 page) (Shava)
...
\section{Monitoring data analysis} (3 - 4 pages) 

\subsection{Test suite description} (2 pages, 0.5 page/class) (Shava)
Description of the methodology -- how data was filtered and interpreted.

\subsection{Results} (Sameer)

\subsection{SSH data}
\subsubsection{Failure Classification:} What types of failures do we see?

\begin{figure*}
\begin{center}
\includegraphics[scale=0.60]{figs/fg-failure-counts}
\caption{Failure Classification}
\label{fig:fg-failure-counts}
\end{center}
\end{figure*}    
...
$ MTBF$ =  $\Sigma$ (start of downtime - start of uptime) $/$ (number of failures)
% \end{equation}
...
\centering
\mbox{
\subfigure[MTBF for all FutureGrid sites ]{
   \includegraphics[scale =0.70] {figs/MTBF}
   \label{fig:subfig1}
 }\quad

 \subfigure[Failure counts for all FugureGrid sites]{
   \includegraphics[scale =0.70] {figs/site-level-failure-count}
   \label{fig:subfig2}
 }
}
\centering
\label{myfigure}
\caption{Android software stack and its comparison with Linux}
\end{figure*}
...
\begin{tabular}{| l | c | c | c | c | }
 \hline
Nimbus & tacc-alamo  & uc-hotel & ucsd-sierra  & ufl-foxtrot   \\
  \hline
clientStatus & 98\% & 96\% &  81\% &  80\% \\  \hline
create-publicvm & 93\%& 89\% &  91\% & 58\% \\  \hline
storage & 100\% & 97\% & 98\% &  99\% \\  \hline

\end{tabular}
\caption{Nimbus: Reliability across FutureGrid machines}
 \label{tab:nimbus-fg-reliability} 
...
\begin{tabular}{| l | c | c | c | c | }
 \hline
Eucalyptus & iu-india  & ucsd-sierra    \\
  \hline
clientStatus & 96\% & 93\%  \\  \hline
create-publicvm & 77\%& 56\%  \\  \hline
storage & 100\% & 97\%   \\  \hline

\end{tabular}
\caption{Eucalyptus: Reliability across FutureGrid machines}
 \label{tab:eucalyptus-fg-reliability} 
\end{table*}
...
Openstack & iu-india      \\
  \hline
clientStatus & 97\%   \\  \hline
create-publicvm & 71\%  \\  \hline
storage & 80\%  \\  \hline

\end{tabular}
\caption{Openstack: Reliability across FutureGrid machines}
 \label{tab:openstack-fg-reliability} 
...
\begin{tabular}{| l | c | c | c | c | c | c | c | }
 \hline
HPC jobs & iu-bravo & iu-delta & iu-india  & iu-xray  & tacc-alamo & uc-hotel & ucsd-sierra \\
  \hline
batch-testjob & & & 88\% & 97\% &   77\% &  100 & 99\% \% \\  \hline
batch-testjob\_to\_bravo & 99\% & & & & & & \\  \hline
batch-testjob\_to\_delta &  & 95\% & & & & & \\  \hline
CUDA-testjob\_to\_delta &  & 95\% & & & & & \\  \hline
myhadoop &  & & 54\% & & 59\% & 89\% & 47\%  \\  \hline

\end{tabular}
\caption{HPC jobs: Reliability across FutureGrid machines}
 \label{tab:hpc-fg-reliability} 
...
\begin{tabular}{| l | c | c | c | c | }
 \hline
HPCC jobs & iu-india  & iu-xray & ucsd-sierra    \\
  \hline
hpcc8 & 99\% & 97\% & 72\% \\  \hline
hpcc16 & 99\% & 96\% & \\  \hline
hpcc32 &  & 95\% &   \\  \hline
hpcc64 & 97\% & 96\% &  \\  \hline
hpcc128 & 93\% & 93\% &   \\  \hline
...
\end{tabular}
\caption{HPCC jobs: Reliability across FutureGrid machines}
 \label{tab:hpcc-fg-reliability} 
\end{table*}
...
\section{Lessons Learned / Best Practices} (1 page) (Shava and Sameer)
 
\section{Related Work} (0.5 page) (Shava and Sameer)

\section{Future Work} (0.25 page) (Shava and Sameer)

\section{Conclusion} (0.25 page) (Shava and Sameer)
