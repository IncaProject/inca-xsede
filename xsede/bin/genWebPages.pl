...
my %pages = (
  ...
  'ctssv4-test.html' => "http://$hostport/inca/jsp/status.jsp?supportLevel=testing&suiteNames=science-gateway.teragrid.org-4.1.0&resourceIds=science-gateway.teragrid.org-4.1.0&xml=science-gateway.teragrid.org-4.1.0.xml&xsl=swStack.xsl&noCategoryHeaders"
);
my $errors = "";
