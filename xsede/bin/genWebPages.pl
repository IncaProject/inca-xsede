...
my $c4jsp = "http://$hostport/inca/jsp/status.jsp?suiteNames=core.teragrid.org-4.0.0,data-management.teragrid.org-4.0.0,data-movement.teragrid.org-4.1.0,data-movement.teragrid.org-4.1.1,data-movement.teragrid.org-4.1.2,remote-compute.teragrid.org-3.0.0,remote-compute.teragrid.org-4.0.2,login.teragrid.org-4.0.0,login.teragrid.org-4.0.2,app-support.teragrid.org-4.0.0,app-support.teragrid.org-4.0.1,app-support.teragrid.org-4.0.2,parallel-app.teragrid.org-4.0.0,parallel-app.teragrid.org-4.0.1,workflow.teragrid.org-4.0.0,vtss.teragrid.org-3.0.0&resourceIds=core.teragrid.org-4.0.0,data-management.teragrid.org-4.0.0,data-movement.teragrid.org-4.1.0,data-movement.teragrid.org-4.1.1,data-movement.teragrid.org-4.1.2,remote-compute.teragrid.org-3.0.0,remote-compute.teragrid.org-4.0.2,login.teragrid.org-4.0.0,login.teragrid.org-4.0.2,app-support.teragrid.org-4.0.0,app-support.teragrid.org-4.0.1,app-support.teragrid.org-4.0.2,parallel-app.teragrid.org-4.0.0,parallel-app.teragrid.org-4.0.1,workflow.teragrid.org-4.0.0,vtss.teragrid.org-3.0.0";
