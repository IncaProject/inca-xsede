...
# get ctssv4 test kit
echo "$date = $?" >> ${HOME}/genWebPages.log
wget -o /dev/null -O $c4testtmp "http://sapa.sdsc.edu:8080/inca/xslt.jsp?supportLevel=testing&suiteName=remote-compute.teragrid.org-3.0.0,remote-compute.teragrid.org-4.0.0&resourceID=remote-compute.teragrid.org-3.0.0,remote-compute.teragrid.org-4.0.0&xmlFile=remote-compute.teragrid.org-3.0.0.xml,remote-compute.teragrid.org-4.0.0.xml&xsl=ctssv4.xsl"
if ( test $? -ne 0 ); then
