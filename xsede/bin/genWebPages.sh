...
c4testjsp="http://sapa.sdsc.edu:8080/inca/xslt.jsp?supportLevel=testing&suiteName=core.teragrid.org-4.0.0,data-movement.teragrid.org-4.1.0,remote-compute.teragrid.org-4.0.0,app-support.teragrid.org-4.0.0,parallel-app.teragrid.org-4.0.0,workflow.teragrid.org-4.0.0&resourceID=core.teragrid.org-4.0.0,data-movement.teragrid.org-4.1.0,remote-compute.teragrid.org-4.0.0,app-support.teragrid.org-4.0.0,parallel-app.teragrid.org-4.0.0,workflow.teragrid.org-4.0.0&xmlFile=core.teragrid.org-4.0.0.xml,data-movement.teragrid.org-4.1.0.xml,remote-compute.teragrid.org-4.0.0.xml,app-support.teragrid.org-4.0.0.xml,parallel-app.teragrid.org-4.0.0.xml,workflow.teragrid.org-4.0.0.xml&xsl=ctssv4.xsl"
c4url=$c4jsp$c4xml
...
# get ctssv4 test kit
echo "$date = $?" >> ${HOME}/logs/genWebPages.log
wget -o /dev/null -O $c4testtmp $c4testjsp 
if ( test $? -ne 0 ); then
