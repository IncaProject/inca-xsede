...
<table xmlns:sdf="java.text.SimpleDateFormat" xmlns:date="java.util.Date" xmlns:xdt="http://www.w3.org/2004/07/xpath-datatypes" width="100%" border="0"><tr align="left"><td><h1 class="body">Inca Status Pages for TeraGrid</h1></td></tr></table>
                        ...
                        <map name="Map">
                          ...
                          <area shape="rect" coords="221,21,376,161" href="summaryHistory.jsp?groupBy=resource" alt="Resource Status History" onMouseOver="MM_swapImage('Image1','','../img/homepage/resource-status-history.jpg',1)" onMouseOut="MM_swapImgRestore()">
