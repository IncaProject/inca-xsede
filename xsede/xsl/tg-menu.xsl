    ...
    <script type="text/javascript">
      function setResourceAndXml(){
        ...
        if (document.form.suiteNames.value.match(/,/)){
          document.form.xml.value = "core.teragrid.org-4.0.0.xml,data-management.teragrid.org-4.0.0.xml,data-movement.teragrid.org-4.1.0.xml,data-movement.teragrid.org-4.1.1.xml,data-movement.teragrid.org-4.1.2.xml,remote-compute.teragrid.org-3.0.0.xml,remote-compute.teragrid.org-4.0.0.xml,remote-compute.teragrid.org-4.0.2.xml,login.teragrid.org-4.0.0.xml,app-support.teragrid.org-4.0.0.xml,parallel-app.teragrid.org-4.0.0.xml,workflow.teragrid.org-4.0.0.xml,vtss.teragrid.org-3.0.0.xml";
        }
      ...
      <table cellpadding="2">
        <tr><td><p>KIT:<br/>
          <select name="suiteNames">
            <option value="core.teragrid.org-4.0.0,data-management.teragrid.org-4.0.0,data-movement.teragrid.org-4.1.0,data-movement.teragrid.org-4.1.1,data-movement.teragrid.org-4.1.2,remote-compute.teragrid.org-3.0.0,remote-compute.teragrid.org-4.0.0,remote-compute.teragrid.org-4.0.2,login.teragrid.org-4.0.0,app-support.teragrid.org-4.0.0,parallel-app.teragrid.org-4.0.0,workflow.teragrid.org-4.0.0,vtss.teragrid.org-3.0.0">- Select One -</option>
