    ...
    <script type="text/javascript">
      function setResourceAndXml(){
        ...
        if (document.form.suiteNames.value.match(/,/)){
          document.form.xml.value = "core.teragrid.org-4.0.0.xml,core.teragrid.org-4.0.2.xml,core.teragrid.org-4.1.0.xml,data-management.teragrid.org-4.0.0.xml,data-movement.teragrid.org-4.1.0.xml,data-movement.teragrid.org-4.1.1.xml,data-movement.teragrid.org-4.1.2.xml,remote-compute.teragrid.org-3.0.0.xml,remote-compute.teragrid.org-4.0.2.xml,login.teragrid.org-4.0.0.xml,login.teragrid.org-4.0.2.xml,app-support.teragrid.org-4.0.0.xml,app-support.teragrid.org-4.0.1.xml,app-support.teragrid.org-4.0.2.xml,app-support.teragrid.org-4.0.3.xml,parallel-app.teragrid.org-4.0.0.xml,parallel-app.teragrid.org-4.0.1.xml,workflow.teragrid.org-4.0.0.xml,vtss.teragrid.org-3.0.0.xml,wan-gpfs.teragrid.org-4.0.0.xml,wan-lustre.teragrid.org-4.0.0.xml,science-gateway.teragrid.org-4.1.0.xml,advance-reservation.teragrid.org-1.0.0.xml,coscheduling.teragrid.org-1.0.0.xml";
        }
      ...
      <table cellpadding="2">
        <tr><td><p>KIT:<br/>
          <select name="suiteNames">
            <option value="core.teragrid.org-4.0.0,core.teragrid.org-4.0.2,core.teragrid.org-4.1.0,data-management.teragrid.org-4.0.0,data-movement.teragrid.org-4.1.0,data-movement.teragrid.org-4.1.1,data-movement.teragrid.org-4.1.2,remote-compute.teragrid.org-3.0.0,remote-compute.teragrid.org-4.0.2,login.teragrid.org-4.0.0,login.teragrid.org-4.0.2,app-support.teragrid.org-4.0.0,app-support.teragrid.org-4.0.1,app-support.teragrid.org-4.0.2,app-support.teragrid.org-4.0.3,parallel-app.teragrid.org-4.0.0,parallel-app.teragrid.org-4.0.1,workflow.teragrid.org-4.0.0,vtss.teragrid.org-3.0.0,wan-gpfs.teragrid.org-4.0.0,wan-lustre.teragrid.org-4.0.0,science-gateway.teragrid.org-4.1.0,advance-reservation.teragrid.org-1.0.0,coscheduling.teragrid.org-1.0.0">- Select One -</option>
            <option value="core.teragrid.org-4.0.0,core.teragrid.org-4.0.2,core.teragrid.org-4.1.0,data-management.teragrid.org-4.0.0,data-movement.teragrid.org-4.1.0,data-movement.teragrid.org-4.1.1,data-movement.teragrid.org-4.1.2,remote-compute.teragrid.org-3.0.0,remote-compute.teragrid.org-4.0.2,login.teragrid.org-4.0.0,login.teragrid.org-4.0.2,app-support.teragrid.org-4.0.0,app-support.teragrid.org-4.0.1,app-support.teragrid.org-4.0.2,app-support.teragrid.org-4.0.3,parallel-app.teragrid.org-4.0.0,parallel-app.teragrid.org-4.0.1,workflow.teragrid.org-4.0.0,vtss.teragrid.org-3.0.0,wan-gpfs.teragrid.org-4.0.0,wan-lustre.teragrid.org-4.0.0,science-gateway.teragrid.org-4.1.0,advance-reservation.teragrid.org-1.0.0,coscheduling.teragrid.org-1.0.0">ALL KITS</option>
            ...
            <option value="core.teragrid.org-4.1.0">Core Integration 4.1.0</option>
