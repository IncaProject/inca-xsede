      ...
      <table cellpadding="2">
        <tr><td><p>KIT:<br/>
          <select name="suiteNames">
            <option value="core.teragrid.org-4.0.0,core.teragrid.org-4.0.2,core.teragrid.org-4.2.0,data-management.teragrid.org-4.0.0,data-movement.teragrid.org-4.1.0,data-movement.teragrid.org-4.1.2,remote-compute.teragrid.org-4.0.2,login.teragrid.org-4.0.0,login.teragrid.org-4.0.2,app-support.teragrid.org-4.0.0,app-support.teragrid.org-4.0.1,app-support.teragrid.org-4.0.2,app-support.teragrid.org-4.0.3,parallel-app.teragrid.org-4.0.0,parallel-app.teragrid.org-4.0.1,workflow.teragrid.org-4.0.0,vtss.teragrid.org-3.0.0,wan-gpfs.teragrid.org-4.0.0,wan-lustre.teragrid.org-4.0.0,science-gateway.teragrid.org-4.1.0,science-gateway.teragrid.org-4.2.0,advance-reservation.teragrid.org-1.0.0,coscheduling.teragrid.org-1.0.0">- Select One -</option>
